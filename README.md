...
- Acesso as informaões mais detalhadas de cada filme que for selecionado.
- Opção de salvar e também de acessar o trailer do filme que foi escolhido.
 ...
 - Opção de excluir os filmes que estiverem na lista de favoritos.
 - Apos a lista ficar vazia uma tela surgi com a sugestão de navegar para a Home da aplicação.
